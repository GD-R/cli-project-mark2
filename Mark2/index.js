...
let questions = ["What is NeoG Camp ? ", "Who is the Owner of NeoG Camp? ", "What Does NeoG Camp Offers? ", "How many levels are there in NeoG Camp? "]

// 2DArray of Set of Answers for each Question
let answers = [["Bootcamp", "Online Course", "Other"], ["Ram", "Tanaypratap", "Pratap"], ["Data science", "WebDevlopment", "Digital Marketing"], ["Level 1", "Level 3", "Level 2"]];

// Array of Correct Answer
let correct_ans = ["Bootcamp", "Tanaypratap", "WebDevlopment", "Level 2"];
